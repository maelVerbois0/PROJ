...
Ils restent donc plus pertinent pour la plupart des instances de comparer la valeur de l'objectif obtenue avec la borne robuste obtenue par la relaxation par pseudo-clique.
Néanmoins, sous réserve de pouvoir fermer l'instance, les bornes renvoyées par génération de colonnes sont plus intéressantes que les bornes combinatoires établient avant
\subsubsection*{Quelques Résultats}
